...
IF ~HaveSpell(2101)~ THEN REPLY #12030 DO ~TakePartyGold(50) DestroyGold(50) RemoveSpell(2101) GiveItemCreate("%TUTU_VAR%SCRL66",Myself,1,1,1)~ EXIT // Grease
IF ~HaveSpell(2102)~ THEN REPLY #12031 DO ~TakePartyGold(50) DestroyGold(50) RemoveSpell(2102) GiveItemCreate("%TUTU_VAR%SCRL67",Myself,1,1,1)~ EXIT // Armor
IF ~HaveSpell(2103)~ THEN REPLY #12074 DO ~TakePartyGold(50) DestroyGold(50) RemoveSpell(2103) GiveItemCreate("%TUTU_VAR%SCRL68",Myself,1,1,1)~ EXIT // Burning Hands
IF ~HaveSpell(2104)~ THEN REPLY #12045 DO ~TakePartyGold(50) DestroyGold(50) RemoveSpell(2104) GiveItemCreate("%TUTU_VAR%SCRL69",Myself,1,1,1)~ EXIT // Charm Person
IF ~HaveSpell(2105)~ THEN REPLY #12075 DO ~TakePartyGold(50) DestroyGold(50) RemoveSpell(2105) GiveItemCreate("%TUTU_VAR%SCRL70",Myself,1,1,1)~ EXIT // Color Spray
IF ~HaveSpell(2106)~ THEN REPLY #12015 DO ~TakePartyGold(50) DestroyGold(50) RemoveSpell(2106) GiveItemCreate("%TUTU_VAR%SCRL71",Myself,1,1,1)~ EXIT // Blindness
IF ~HaveSpell(2107)~ THEN REPLY #12046 DO ~TakePartyGold(50) DestroyGold(50) RemoveSpell(2107) GiveItemCreate("%TUTU_VAR%SCRL72",Myself,1,1,1)~ EXIT // Friends
IF ~HaveSpell(2108)~ THEN REPLY #12024 DO ~TakePartyGold(50) DestroyGold(50) RemoveSpell(2108) GiveItemCreate("%TUTU_VAR%SCRL73",Myself,1,1,1)~ EXIT // Protection From Petrification
...
IF ~HaveSpell(2111)~ THEN REPLY ~%InfravisionText%~ DO ~TakePartyGold(50) DestroyGold(50) RemoveSpell(2111) GiveItemCreate("%TUTU_VAR%SCRL76",Myself,1,1,1)~ EXIT // Infravision
IF ~HaveSpell(2112)~ THEN REPLY #12052 DO ~TakePartyGold(50) DestroyGold(50) RemoveSpell(2112) GiveItemCreate("%TUTU_VAR%SCRL77",Myself,1,1,1)~ EXIT // Magic Missile
IF ~HaveSpell(2113)~ THEN REPLY #12023 DO ~TakePartyGold(50) DestroyGold(50) RemoveSpell(2113) GiveItemCreate("%TUTU_VAR%SCRL78",Myself,1,1,1)~ EXIT // Protection From Evil
IF ~HaveSpell(2114)~ THEN REPLY #12053 DO ~TakePartyGold(50) DestroyGold(50) RemoveSpell(2114) GiveItemCreate("%TUTU_VAR%SCRL79",Myself,1,1,1)~ EXIT // Shield
IF ~HaveSpell(2115)~ THEN REPLY #12076 DO ~TakePartyGold(50) DestroyGold(50) RemoveSpell(2115) GiveItemCreate("%TUTU_VAR%SCRL80",Myself,1,1,1)~ EXIT // Shocking Grasp
IF ~HaveSpell(2116)~ THEN REPLY #12047 DO ~TakePartyGold(50) DestroyGold(50) RemoveSpell(2116) GiveItemCreate("%TUTU_VAR%SCRL81",Myself,1,1,1)~ EXIT // Sleep
IF ~HaveSpell(2117)~ THEN REPLY #12067 DO ~TakePartyGold(50) DestroyGold(50) RemoveSpell(2117) GiveItemCreate("%TUTU_VAR%SCRL82",Myself,1,1,1)~ EXIT // Chill Touch
IF ~HaveSpell(2118)~ THEN REPLY #12054 DO ~TakePartyGold(50) DestroyGold(50) RemoveSpell(2118) GiveItemCreate("%TUTU_VAR%SCRL83",Myself,1,1,1)~ EXIT // Chromatic Orb
IF ~HaveSpell(2119)~ THEN REPLY #12068 DO ~TakePartyGold(50) DestroyGold(50) RemoveSpell(2119) GiveItemCreate("%TUTU_VAR%SCRL84",Myself,1,1,1)~ EXIT // Larloch's Minor Drain
...
SAY @8260 // (Choose which spell to scribe onto a scroll.)
IF ~HaveSpell(2201)~ THEN REPLY #12016 DO ~TakePartyGold(100) DestroyGold(100) RemoveSpell(2201) GiveItemCreate("%TUTU_VAR%SCRL85",Myself,1,1,1)~ EXIT // Blur
IF ~HaveSpell(2202)~ THEN REPLY #12041 DO ~TakePartyGold(100) DestroyGold(100) RemoveSpell(2202) GiveItemCreate("%TUTU_VAR%SCRL86",Myself,1,1,1)~ EXIT // Detect Evil
IF ~HaveSpell(2203)~ THEN REPLY #12042 DO ~TakePartyGold(100) DestroyGold(100) RemoveSpell(2203) GiveItemCreate("%TUTU_VAR%SCRL87",Myself,1,1,1)~ EXIT // Detect Invisibilty
IF ~HaveSpell(2205)~ THEN REPLY #12069 DO ~TakePartyGold(100) DestroyGold(100) RemoveSpell(2205) GiveItemCreate("%TUTU_VAR%SCRL89",Myself,1,1,1)~ EXIT // Horror
IF ~HaveSpell(2206)~ THEN REPLY #12017 DO ~TakePartyGold(100) DestroyGold(100) RemoveSpell(2206) GiveItemCreate("%TUTU_VAR%SCRL90",Myself,1,1,1)~ EXIT // Invisibilty
IF ~HaveSpell(2207)~ THEN REPLY #12131 DO ~TakePartyGold(100) DestroyGold(100) RemoveSpell(2207) GiveItemCreate("%TUTU_VAR%SCRL91",Myself,1,1,1)~ EXIT // Knock
IF ~HaveSpell(2208)~ THEN REPLY ~%KnowAlignmentText%~ DO ~TakePartyGold(100) DestroyGold(100) RemoveSpell(2208) GiveItemCreate("%TUTU_VAR%SCRL92",Myself,1,1,1)~ EXIT // Know Alignment
IF ~HaveSpell(2209)~ THEN REPLY #12048 DO ~TakePartyGold(100) DestroyGold(100) RemoveSpell(2209) GiveItemCreate("%TUTU_VAR%SCRL93",Myself,1,1,1)~ EXIT // Luck
IF ~HaveSpell(2210)~ THEN REPLY #12025 DO ~TakePartyGold(100) DestroyGold(100) RemoveSpell(2210) GiveItemCreate("%TUTU_VAR%SCRL94",Myself,1,1,1)~ EXIT // Resist Fear
IF ~HaveSpell(2211)~ THEN REPLY #12033 DO ~TakePartyGold(100) DestroyGold(100) RemoveSpell(2211) GiveItemCreate("%TUTU_VAR%SCRL95",Myself,1,1,1)~ EXIT // Melf's Acid Arrow
IF ~HaveSpell(2212)~ THEN REPLY #12018 DO ~TakePartyGold(100) DestroyGold(100) RemoveSpell(2212) GiveItemCreate("%TUTU_VAR%SCRL96",Myself,1,1,1)~ EXIT // Mirror Image
IF ~HaveSpell(2213)~ THEN REPLY #12056 DO ~TakePartyGold(100) DestroyGold(100) RemoveSpell(2213) GiveItemCreate("%TUTU_VAR%SCRL97",Myself,1,1,1)~ EXIT // Stinking Cloud
IF ~HaveSpell(2214)~ THEN REPLY #12077 DO ~TakePartyGold(100) DestroyGold(100) RemoveSpell(2214) GiveItemCreate("%TUTU_VAR%SCRL98",Myself,1,1,1)~ EXIT // Strength
IF ~HaveSpell(2215)~ THEN REPLY #12057 DO ~TakePartyGold(100) DestroyGold(100) RemoveSpell(2215) GiveItemCreate("%TUTU_VAR%SCRL99",Myself,1,1,1)~ EXIT // Web
IF ~HaveSpell(2217)~ THEN REPLY #12058 DO ~TakePartyGold(100) DestroyGold(100) RemoveSpell(2217) GiveItemCreate("%TUTU_VAR%SCRL1B",Myself,1,1,1)~ EXIT // Agannazar's Scorcher
IF ~HaveSpell(2218)~ THEN REPLY #12070 DO ~TakePartyGold(100) DestroyGold(100) RemoveSpell(2218) GiveItemCreate("%TUTU_VAR%SCRL1C",Myself,1,1,1)~ EXIT // Ghoul Touch
IF ~HaveSpell(2219)~ THEN REPLY #12079 DO ~TakePartyGold(100) DestroyGold(100) RemoveSpell(2219) GiveItemCreate("%TUTU_VAR%SCRL3G",Myself,1,1,1)~ EXIT // Vocalize
...
SAY @8260 // (Choose which spell to scribe onto a scroll.)
IF ~HaveSpell(2301)~ THEN REPLY #12044 DO ~TakePartyGold(150) DestroyGold(150) RemoveSpell(2301) GiveItemCreate("%TUTU_VAR%SCRL1D",Myself,1,1,1)~ EXIT // Clairvoyance
...
IF ~HaveSpell(2303)~ THEN REPLY #12034 DO ~TakePartyGold(150) DestroyGold(150) RemoveSpell(2303) GiveItemCreate("%TUTU_VAR%SCRL1F",Myself,1,1,1)~ EXIT // Flame Arrow
IF ~HaveSpell(2304)~ THEN REPLY #6618 DO ~TakePartyGold(150) DestroyGold(150) RemoveSpell(2304) GiveItemCreate("%TUTU_VAR%SCRL1G",Myself,1,1,1)~ EXIT // Fireball
IF ~HaveSpell(2305)~ THEN REPLY #12080 DO ~TakePartyGold(150) DestroyGold(150) RemoveSpell(2305) GiveItemCreate("%TUTU_VAR%SCRL1H",Myself,1,1,1)~ EXIT // Haste
IF ~HaveSpell(2306)~ THEN REPLY #12049 DO ~TakePartyGold(150) DestroyGold(150) RemoveSpell(2306) GiveItemCreate("%TUTU_VAR%SCRL1I",Myself,1,1,1)~ EXIT // Hold Person
...
IF ~HaveSpell(2308)~ THEN REPLY #12060 DO ~TakePartyGold(150) DestroyGold(150) RemoveSpell(2308) GiveItemCreate("%TUTU_VAR%SCRL1K",Myself,1,1,1)~ EXIT // Lightning Bolt
IF ~HaveSpell(2309)~ THEN REPLY #12035 DO ~TakePartyGold(150) DestroyGold(150) RemoveSpell(2309) GiveItemCreate("%TUTU_VAR%SCRL1L",Myself,1,1,1)~ EXIT // Monster Summoning I
IF ~HaveSpell(2310)~ THEN REPLY #12027 DO ~TakePartyGold(150) DestroyGold(150) RemoveSpell(2310) GiveItemCreate("%TUTU_VAR%SCRL1M",Myself,1,1,1)~ EXIT // Non-Detection
IF ~HaveSpell(2311)~ THEN REPLY #12028 DO ~TakePartyGold(150) DestroyGold(150) RemoveSpell(2311) GiveItemCreate("%TUTU_VAR%SCRL1N",Myself,1,1,1)~ EXIT // Protection From Normal Missiles
IF ~HaveSpell(2312)~ THEN REPLY #12081 DO ~TakePartyGold(150) DestroyGold(150) RemoveSpell(2312) GiveItemCreate("%TUTU_VAR%SCRL1O",Myself,1,1,1)~ EXIT // Slow
IF ~HaveSpell(2313)~ THEN REPLY #12072 DO ~TakePartyGold(150) DestroyGold(150) RemoveSpell(2313) GiveItemCreate("%TUTU_VAR%SCRL1P",Myself,1,1,1)~ EXIT // Skull Trap
IF ~HaveSpell(2314)~ THEN REPLY #12071 DO ~TakePartyGold(150) DestroyGold(150) RemoveSpell(2314) GiveItemCreate("%TUTU_VAR%SCRL1Q",Myself,1,1,1)~ EXIT // Vampiric Touch
IF ~HaveSpell(2316)~ THEN REPLY #12050 DO ~TakePartyGold(150) DestroyGold(150) RemoveSpell(2316) GiveItemCreate("%TUTU_VAR%SCRL1S",Myself,1,1,1)~ EXIT // Dire Charm
IF ~HaveSpell(2317)~ THEN REPLY #12129 DO ~TakePartyGold(150) DestroyGold(150) RemoveSpell(2317) GiveItemCreate("%TUTU_VAR%SCRL1T",Myself,1,1,1)~ EXIT // Ghost Armor
...
IF ~HaveSpell(2326)~ THEN REPLY #12026 DO ~TakePartyGold(150) DestroyGold(150) RemoveSpell(2326) GiveItemCreate("%TUTU_VAR%SCRL1E",Myself,1,1,1)~ EXIT // Dispel Magic
%SpellPackL3%
IF ~~ THEN REPLY @8261 GOTO RR#SCRL00 // Select a different spell level
END
...
SAY @8260 // (Choose which spell to scribe onto a scroll.)
IF ~HaveSpell(2401)~ THEN REPLY #12051 DO ~TakePartyGold(250) DestroyGold(250) RemoveSpell(2401) GiveItemCreate("%TUTU_VAR%SCRL1U",Myself,1,1,1)~ EXIT // Confusion
...
IF ~HaveSpell(2405)~ THEN REPLY #12021 DO ~TakePartyGold(250) DestroyGold(250) RemoveSpell(2405) GiveItemCreate("%TUTU_VAR%SCRL1Y",Myself,1,1,1)~ EXIT // Improved Invisibility
IF ~HaveSpell(2406)~ THEN REPLY #12029 DO ~TakePartyGold(250) DestroyGold(250) RemoveSpell(2406) GiveItemCreate("%TUTU_VAR%SCRL1Z",Myself,1,1,1)~ EXIT // Minor Globe of Invulnerability
IF ~HaveSpell(2407)~ THEN REPLY #12037 DO ~TakePartyGold(250) DestroyGold(250) RemoveSpell(2407) GiveItemCreate("%TUTU_VAR%SCRL2A",Myself,1,1,1)~ EXIT // Monster Summoning II
...
IF ~HaveSpell(2410)~ THEN REPLY ~%RemoveCurseText%~ DO ~TakePartyGold(250) DestroyGold(250) RemoveSpell(2410) GiveItemCreate("%TUTU_VAR%SCRL5G",Myself,1,1,1)~ EXIT // Remove Curse
IF ~HaveSpell(2411)~ THEN REPLY #22173 DO ~TakePartyGold(250) DestroyGold(250) RemoveSpell(2411) GiveItemCreate("%TUTU_VAR%SCRL5H",Myself,1,1,1)~ EXIT // Emotion
IF ~HaveSpell(2412)~ THEN REPLY #22185 DO ~TakePartyGold(250) DestroyGold(250) RemoveSpell(2412) GiveItemCreate("%TUTU_VAR%SCRL5I",Myself,1,1,1)~ EXIT // Greater Malison
IF ~HaveSpell(2413)~ THEN REPLY #22177 DO ~TakePartyGold(250) DestroyGold(250) RemoveSpell(2413) GiveItemCreate("%TUTU_VAR%SCRL5J",Myself,1,1,1)~ EXIT // Oliluke's Resilient Sphere
IF ~HaveSpell(2414)~ THEN REPLY #22608 DO ~TakePartyGold(250) DestroyGold(250) RemoveSpell(2414) GiveItemCreate("%TUTU_VAR%SCRL5K",Myself,1,1,1)~ EXIT // Spirit Armor
...
IF ~HaveSpell(2416)~ THEN REPLY #22316 DO ~TakePartyGold(250) DestroyGold(250) RemoveSpell(2416) GiveItemCreate("%TUTU_VAR%SCRL5M",Myself,1,1,1)~ EXIT // Polymorph Self
...
IF ~HaveSpell(2502)~ THEN REPLY #12065 DO ~TakePartyGold(500) DestroyGold(500) RemoveSpell(2502) GiveItemCreate("%TUTU_VAR%SCRL2E",Myself,1,1,1)~ EXIT // Cloudkill
...
IF ~HaveSpell(2504)~ THEN REPLY #12038 DO ~TakePartyGold(500) DestroyGold(500) RemoveSpell(2504) GiveItemCreate("%TUTU_VAR%SCRL2G",Myself,1,1,1)~ EXIT // Monster Summoning III
...
IF ~HaveSpell(2506)~ THEN REPLY #22614 DO ~TakePartyGold(500) DestroyGold(500) RemoveSpell(2506) GiveItemCreate("%TUTU_VAR%SCRL5N",Myself,1,1,1)~ EXIT // Domination
IF ~HaveSpell(2507)~ THEN REPLY #22616 DO ~TakePartyGold(500) DestroyGold(500) RemoveSpell(2507) GiveItemCreate("%TUTU_VAR%SCRL5O",Myself,1,1,1)~ EXIT // Hold Monster
IF ~HaveSpell(2508)~ THEN REPLY #22610 DO ~TakePartyGold(500) DestroyGold(500) RemoveSpell(2508) GiveItemCreate("%TUTU_VAR%SCRL5P",Myself,1,1,1)~ EXIT // Chaos
IF ~HaveSpell(2509)~ THEN REPLY #22612 DO ~TakePartyGold(500) DestroyGold(500) RemoveSpell(2509) GiveItemCreate("%TUTU_VAR%SCRL5Q",Myself,1,1,1)~ EXIT // Feeblemind
